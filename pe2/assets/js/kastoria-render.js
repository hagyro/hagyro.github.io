...
(function () {
  ...
  C.ipa('chart_ipa', {
    x: [0.36, 0.33, 0.30, 0.20, 0.27, 0.18, 0.21, 0.13, 0.0, 0.22, 0.19, 0.24, 0.18, 0.21, 0.25],
    y: [3.89, 4.16, 3.86, 3.24, 3.40, 3.10, 3.20, 2.95, 0.0, 3.40, 3.85, 3.95, 3.92, 3.88, 3.85],
    labels: ['Καταλύματα (επάρκεια)','Καταλύματα (ποιότητα)','Χώροι εστίασης','Γεν. τουρ. υποδομές','Διασκέδαση','Τοπικό οδικό','Στάθμευση','Σύνδεση Ελλάδα','Ακτοπλοΐα (N/A)','Δημ. Υγεία','Αστυνόμευση','Ύδρευση','Αποχέτευση','Απορρίμματα','Τηλεπ./Internet'],
