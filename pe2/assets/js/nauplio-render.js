/* ============================================================
   Ναύπλιο rendering: διαβάζει window.WB_DATA (inlined από
   nauplio-data.js). CORS-safe — δουλεύει και με file:// protocol.
   ============================================================ */

(function () {
  const data = window.WB_DATA;
  if (!data) { console.error('WB_DATA not loaded — include nauplio-data.js before nauplio-render.js'); return; }
